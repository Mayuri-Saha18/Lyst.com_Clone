...
const Login = () => {
  ...
  return (
    <div>
      ...
      <Box mt={10} padding="6" fontSize={30} fontWeight="600">
        Log In
      </Box>
      ...
      >
        <Text
          ...
          fontWeight={500}
        >
          The only fashion site you need
        </Text>
      ...
      <Box m="autom" mt={10}>
        <Image src="https://media.glamour.com/photos/5695d2c093ef4b09520ef0d1/master/w_1600%2Cc_limit/fashion-2013-03-0304-chanel.gif" alt="fgoj" />
      </Box>
      </SimpleGrid>
      <Footer />
    </div>
